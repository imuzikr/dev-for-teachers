...
// 허용 태그: 볼드, 이탤릭, 밑줄, 목록, 줄바꿈, 코드 블록, 제한된 크기 표시
...
const RICH_TEXT_TAG_PATTERN = /<\/?(b|strong|i|em|u|span|ul|ol|li|br|div|p|pre|code|img)\b/i;
  ...
  function walk(node) {
    ...
    [...node.children].forEach((el) => {
      ...
      if (!ALLOWED_TAGS.has(el.tagName)) {
        ...
        const classes = [...el.classList].filter((className) => ALLOWED_CLASSES.has(className));
