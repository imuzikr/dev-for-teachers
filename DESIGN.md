...
- `book-project-item-actions`: 저장된 활동·자료의 열기·전체보기·수정·삭제 명령은 한 행에 정렬한다. 열기는 선택한 항목을 큰 모달로 표시하고, 전체보기는 같은 Step의 항목을 이전·다음으로 탐색할 수 있는 큰 모달을 표시한다. 자료 복사 명령은 내용 박스 오른쪽 위에 두며 본문과 URL을 함께 클립보드에 담는다. 삭제는 확인 절차를 거친다.
