...
try {
  ...
  for (const [file, marker] of [["lib/store.js", "export async function saveBookDashboardText(actId, user, dashboardText) {"], ["lib/bookConfirmations.js", "export async function saveBookConfirmation(input = {}) {"]]) {
