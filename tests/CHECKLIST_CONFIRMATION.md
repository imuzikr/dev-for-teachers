...
Verify partial checklists are rejected at the hook and UI, warning copy/line break, Escape dismissal preserving content and checkbox values, full-check completion, and panel versus enlarged modal close behavior. Existing non-checklist success/failure behavior is covered separately by `confirmModal.browser.mjs`.
