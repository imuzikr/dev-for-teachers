...
async function seedRichFixture(db) {
  ...
  const entries = [
    ...
    [`bookProjectTrash/trashGone`, { classId: GONE, kind: "activity", payload: { id: "activityGone" } }],
    ...
    ["bookProjectTrash/trashKeep", { classId: KEEP, kind: "activity", payload: { id: "activityKeep" } }],
